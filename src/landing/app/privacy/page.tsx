      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">{t('collection_title')}</h2>
            <p>
              {t('collection_text')}
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4">{t('usage_title')}</h2>
            <p>
              {t('usage_text')}
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4">{t('security_title')}</h2>
            <p>
              {t('security_text')}
            </p>
