        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
          <div className="px-6 py-12 md:p-12 md:pb-16 lg:flex lg:items-center lg:justify-between">
            <div className="lg:w-0 lg:flex-1">
              ...
              <motion.p 
                className="mt-4 max-w-3xl text-lg text-gray-500 dark:text-gray-300"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
            ...
            <div className="mt-8 lg:mt-0 lg:ml-8">
              <motion.div 
                className="bg-gray-50 dark:bg-gray-800/30 p-6 rounded-xl"
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-3 text-lg font-medium text-gray-900 dark:text-white">{t('highlight_title')}</h3>
                </div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-black mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600 dark:text-gray-300">{t('highlight_1')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-black mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600 dark:text-gray-300">{t('highlight_2')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-black mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600 dark:text-gray-300">{t('highlight_3')}</span>
                  </li>
                </ul>
              </motion.div>
            </div>
