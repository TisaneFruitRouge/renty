...
const createFormSchema = (t: TFunction) => z.object({
  terminationDate: z.date({ required_error: t("termination-date-required") }),
  terminationReason: z.enum([
    ...
    "BREACH_OF_CONTRACT",
    "OTHER",
  ] as const, { required_error: t("termination-reason-required") }),
  notes: z.string().optional(),
});

type EndLeaseFormData = z.infer<ReturnType<typeof createFormSchema>>;
  ...
  async function onSubmit(values: EndLeaseFormData) {
    try {
      ...
      await terminateLease({
        userId,
        id: lease.id,
        endDate: values.terminationDate.getTime(),
