    ...
    <>
      <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg border border-border hover:border-border/80 transition-colors">
        <div className="flex items-center flex-1 min-w-0">
          <div className="text-muted-foreground mr-3">{getFileIcon()}</div>
        ...
        <div className="flex items-center ml-4 gap-2">
          <Button variant="outline" size="sm" className="text-blue-600 hover:text-blue-800" asChild>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <EditDocumentDialog document={document} propertyId={propertyId}>
                <DropdownMenuItem onSelect={(event) => event.preventDefault()}>
                  <Pencil className="h-4 w-4 mr-2" />
                  {t("edit")}
                </DropdownMenuItem>
              </EditDocumentDialog>
              <DeleteDocumentAlert document={document} propertyId={propertyId}>
                <DropdownMenuItem
