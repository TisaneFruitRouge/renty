...
import { ArrowDown, ArrowRight, ArrowUp, ArrowUpDown, Building2, Mail, Phone, Search, Users } from "lucide-react";
...
export default function TenantsList({ leases, tenants }: TenantsListProps) {
  ...
  const paginatedRows = table.getSortedRowModel().rows.slice((page - 1) * PAGE_SIZE, page * PAGE_SIZE);
