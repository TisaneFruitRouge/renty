...
export default function CreateRentReceiptModal({
  properties,
}: CreateRentReceiptModalProps) {
  ...
  async function onSubmit(
    data: z.infer<NonNullable<typeof createReceiptSchema>>,
    sendMail: boolean,
  ) {
    try {
      ...
      const result = await createRentReceiptAction(sendMail, normalizedData);
      if (!result) {
